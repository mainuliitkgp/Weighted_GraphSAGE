...
class SampleAndAggregate(GeneralizedModel):
    ...
    def __init__(self, placeholders, features, adj, degrees,
        ...
        self.samples1 = placeholders["samples1"]
        self.support_sizes1 = placeholders["support_sizes1"]
        self.samples2 = placeholders["samples2"]
        self.support_sizes2 = placeholders["support_sizes2"]
        self.neg_samples = placeholders["neg_samples"]
        self.neg_support_sizes = placeholders["neg_support_sizes"]
    ...
    def unpad(self):
        unpad_samples1, unpad_samples2, unpad_neg_samples = [], [], []
        for i in range(3):
            unpad_samples1.append(self.samples1[i][0:self.batch_size*self.support_sizes1[i]])

        for i in range(3):
            unpad_samples2.append(self.samples2[i][0:self.batch_size*self.support_sizes2[i]])

        for i in range(3):
            unpad_neg_samples.append(self.neg_samples[i][0:FLAGS.neg_sample_size*self.neg_support_sizes[i]])

        return unpad_samples1, self.support_sizes1, unpad_samples2, self.support_sizes2, unpad_neg_samples, self.neg_support_sizes

    def _build(self):
        # perform "convolution"
        samples1, support_sizes1, samples2, support_sizes2, neg_samples, neg_support_sizes = self.unpad()
